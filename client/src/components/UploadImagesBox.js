...
function UploadImagesBoxComponent(props) {
  ...
  const validationSchema = Yup.object().shape({
    photoName: Yup.string()
      .min(
        5,
        "PhotoName must be at least 5 Characters, Only Letters Or Spaces."
      )
    ...
    <>
      <div className="uploadImage  border-2 w-80 mr-5 my-3">
        <div className="flex justify-end">
          <button
            className="items-center px-1 mr-2 mt-2"
        ...
        <div className="mb-4 p-3 pt-0">
          <label htmlFor="formPhotoName" className="block font-medium mb-2">
            photo Name:
          </label>
          <input
            type="text"
        ...
        <div className="mb-4 p-3">
          <label htmlFor="formPhotoDes" className="block font-medium mb-2">
            photo Description:
          </label>
          <input
            type="text"
